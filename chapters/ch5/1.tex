A first insight of what can we do and what would be the challenges to overcome has been made due to creation of a first working solar cell. The cell was based on PbS QDs and it has shown a promising quantities for further development. The whole paper provides a comparison of Vimun silicon solar cell and our own QDSC.

\subsection{PbS Quantum Dot Solar Cells}
...
\caption{Device and Quantum-Dots produced in our lab}
\end{figure}


\subsection{Results}
\begin{wrapfigure}{l}{0.501\textwidth}
\center
\includegraphics[width=0.5\textwidth]{ch5/bb1stco}
...
\noindent where \(I_{p}\) is a photocurrent output, and P is a ratio of radiant
...
\[N_{p} \approx 1,73 \cdot 10^{24}\]

\[P_{d} \approx 0,23\left( W \right)\ \]
...
\hline
Incident Power {[}W{]} & 2,30E-01 & 5,75E-03 & 1,53E-03\\
\hline
\end{tabular}
